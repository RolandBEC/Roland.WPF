...
namespace Roland.WPF.Controls.Utils
{
    ...
    public class IconHelper
    {
        ...
        /// <summary>
        ///     Returns an icon for a given folder path - indicated by the name parameter.
        /// </summary>
        /// <param name="name">Pathname for folder.</param>
        /// <param name="size">Large or small</param>
        /// <param name="linkOverlay">Whether to include the link icon</param>
        /// <returns>System.Drawing.Icon</returns>
        public static Icon GetFolderIcon(string name, IconSize size, bool linkOverlay)
        {
            Shell32.SHFILEINFO shfi = new Shell32.SHFILEINFO();
            uint flags = Shell32.SHGFI_ICON | Shell32.SHGFI_USEFILEATTRIBUTES;
            ...
            Shell32.SHGetFileInfo(name, Shell32.FILE_ATTRIBUTE_DIRECTORY, ref shfi, (uint)Marshal.SizeOf(shfi), flags);
